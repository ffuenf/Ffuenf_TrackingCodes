...
class Ffuenf_TrackingCodes_Test_Config_Main extends EcomDev_PHPUnit_Test_Case_Config
{
    /**
    ...
    public function testHelperAliases()
    {
        $this->assertHelperAlias(
            'ffuenf_trackingcodes', 'Ffuenf_TrackingCodes_Helper_Data',
